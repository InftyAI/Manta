...
const (
	secretNamespace         = "manta-system"
	serviceName             = "manta-webhook-service"
	secretName              = "manta-webhook-server-cert"
	certDir                 = "/tmp/k8s-webhook-server/serving-certs"
	validateWebhookConfName = "manta-validating-webhook-configuration"
	mutatingWebhookConfName = "manta-mutating-webhook-configuration"
	caName                  = "manta-ca"
	caOrg                   = "manta"
)
